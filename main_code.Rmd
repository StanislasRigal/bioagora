...
# Biophysical regions
grid_eu_mainland_biogeo <- st_read("grid_eu_mainland_biogeo.gpkg")

# Outline of the study area
grid_eu_mainland_outline <- st_read("grid_eu_mainland_outline.gpkg")
...
bird_data <- read.csv("bird_data_publi.csv")
pressure_publi <- read.csv("pressure_publi.csv")
...
butterfly_data <- read.csv("butterfly_data_publi.csv")
pressure_publi_butterfly <- read.csv("pressure_publi_butterfly.csv")
...
res_gamm_bird <- read.csv("res_gamm_bird.csv")
...
res_gamm_butterfly <- read.csv("res_gamm_butterfly.csv")
...
pa_2050 <- rast(raster("predicted_protected_areas/FIG2_3values_expand_top5.tif"))
...
pressure_publi_unscale <- read.csv("pressure_publi_unscale.csv")
...
pressure_publi_butterfly_unscale <- read.csv("pressure_publi_butterfly_unscale.csv")
